    ...
    <div className="fixed inset-0 z-[999] bg-black/95 backdrop-blur-xl flex items-center justify-center p-4">
      <div className="relative w-full max-w-5xl h-[80vh] rounded-3xl overflow-hidden border border-gold-400/20 bg-zinc-900">
        ...
        <div className="absolute bottom-6 right-6 flex gap-3">
          <button 
            onClick={() => {}} 
            className="w-8 h-8 rounded-full bg-[#d4af37] border-2 border-white/20 hover:border-white/60 transition"
          />
          <button 
            onClick={() => {}} 
            className="w-8 h-8 rounded-full bg-black border-2 border-white/20 hover:border-white/60 transition"
          />
          <button 
            onClick={() => {}} 
            className="w-8 h-8 rounded-full bg-white border-2 border-white/20 hover:border-white/60 transition"
          />
          <button 
            onClick={() => {}} 
            className="w-8 h-8 rounded-full bg-red-500 border-2 border-white/20 hover:border-white/60 transition"
          />
        </div>
      </div>
    </div>
