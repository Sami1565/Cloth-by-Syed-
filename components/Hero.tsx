    ...
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black pt-20 sm:pt-24">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center flex flex-col items-center justify-center min-h-[70vh]">
          ...
          {/* Tagline - With proper spacing and line height */}
          <motion.p 
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
            transition={{ delay: 0.4 }} 
            className="text-white/50 text-base sm:text-lg md:text-xl mt-6 tracking-widest font-light max-w-2xl mx-auto px-4 leading-relaxed"
          >
          ...
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
            className="mt-12 flex flex-wrap justify-center gap-6 sm:gap-10 text-white/30 text-[10px] sm:text-xs tracking-[0.2em] uppercase"
          >
