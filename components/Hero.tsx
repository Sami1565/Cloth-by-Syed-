    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-50 text-center max-w-4xl px-4">
        ...
        >
          <Link 
            href="/shop" 
            className="px-10 py-4 rounded-full bg-[#d4af37] text-black font-semibold hover:bg-[#c5a028] transition shadow-lg shadow-[#d4af37]/30 hover:shadow-[#d4af37]/50 text-base"
          >
            Explore Collection →
          </Link>
          ...
          <button 
            onClick={onOpen3D}
            className="px-10 py-4 rounded-full border-2 border-white/30 text-white font-medium hover:bg-white/10 hover:border-[#d4af37] transition text-base"
          >
            View in 3D
          </button>
        </motion.div>
