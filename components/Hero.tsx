    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-50 text-center max-w-4xl px-4">
        ...
        >
          ...
          <Link 
            href="/shop" 
            className="group relative px-10 py-4 rounded-2xl bg-gradient-to-r from-[#d4af37] to-[#f5e7b2] text-black font-bold text-base tracking-wide hover:scale-105 transition-all duration-300 shadow-2xl shadow-[#d4af37]/40 hover:shadow-[#d4af37]/70 overflow-hidden"
          >
            ...
            <span className="absolute inset-0 bg-gradient-to-r from-[#f5e7b2] to-[#d4af37] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </Link>
          
          {/* Secondary Button - View in 3D */}
          <button 
            onClick={onOpen3D}
            className="group relative px-10 py-4 rounded-2xl border-2 border-white/60 text-white font-bold text-base tracking-wide hover:scale-105 transition-all duration-300 hover:border-[#d4af37] hover:text-[#d4af37] overflow-hidden"
          >
            <span className="relative z-10 flex items-center gap-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <motion.div 
          ...
          className="mt-12 flex flex-wrap justify-center gap-6 text-white/20 text-xs tracking-widest"
        >
