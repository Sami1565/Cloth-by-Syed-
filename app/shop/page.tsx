...
export default function Shop() {
  ...
  const getSubCategoriesList = (category: string) => {
    if (category === 'All') return []
    return subData[category as keyof typeof subData] || []
  }
  ...
  const getSubCategoryCount = (category: string, sub: string) => {
    return allProducts.filter(p => p.category === category && p.subCategory === sub).length
  }
